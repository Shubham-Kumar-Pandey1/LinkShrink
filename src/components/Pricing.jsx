...
const Pricing = () => {
  const pricingFeatures = [
    ...
    { title: "Admin Dashboard", desc: "Advanced controls for administrators." }
  ];

  return (
    <section className="bg-gray-900 text-white flex flex-col items-center justify-center px-6 py-16 min-h-screen">
      {/* Hurray Message */}
