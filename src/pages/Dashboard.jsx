...
const Dashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage(
        `Short URL Created: <a href="${shortUrl}" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline">${shortUrl}</a>`
      );
      setOriginalUrl("");
      setFeature("none");
      setPassword("");
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="max-w-lg mx-auto mt-10 p-6 bg-white rounded-lg shadow-lg border border-gray-200">
        <h2 className="text-2xl font-bold text-center mb-2">✨ Welcome, {username}!</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="input input-bordered w-full mt-1 bg-white text-gray-900 border-2 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition-all"
